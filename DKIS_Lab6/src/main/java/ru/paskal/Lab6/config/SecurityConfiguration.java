...
import ru.paskal.Lab6.services.ShopUserDetailsService;

/**
 * Класс конфигурации для настройки SpringSecurity в приложении.
 */
@Configuration
@ComponentScan("ru.paskal.Lab6")
@EnableWebSecurity
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        .authorizeHttpRequests(authz -> authz
            ...
            .requestMatchers("/instruments/*/edit").hasRole("ADMIN")
            .requestMatchers("/instruments/new").hasRole("ADMIN")
        ...
        .formLogin(formLogin ->
            formLogin
                ...
                .defaultSuccessUrl("/instruments", true)
